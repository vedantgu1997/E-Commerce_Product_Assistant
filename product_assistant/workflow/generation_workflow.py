...
def format_docs(docs) -> str:
    """Format retrieved docs into a structured text bloack for the prompt."""
    if not docs:
...
def build_chain():
    """Build RAG pipeline chain with retriever, prompt, LLM, and parser."""
...
def invoke_chain(query: str, debug: bool = False) -> str:
    ...
    if debug:
        ...
        docs = retriever_obj.load_retriever().invoke(query)  # type: ignore
        print("\nRetrieved Documents:")
